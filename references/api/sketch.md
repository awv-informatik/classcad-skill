...
| [param.isConstruction] | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the arc is a construction geometry                                                                              |
...
| [param.isConstruction] | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the circle is a construction geometry                                                                       |
| [param.genFixation]    | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if fixation in the origin should be autogenerated or not (default=TRUE)                                        |
| [param.genIncidence]   | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if coincidence constraints between an existing and the new point should be autogenerated or not (default=TRUE) |
...
| [param.lines[].isConstruction]         | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the line is a construction geometry                                                                               |
...
| [param.arcsBy3Points[].isConstruction] | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the arc is a construction geometry                                                                                |
...
| [param.arcsByCenter[].isConstruction]  | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the arc is a construction geometry                                                                                |
...
| [param.circles[].isConstruction]       | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the circle is a construction geometry                                                                             |
| [param.genFixation]                    | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if fixation in the Origin should be autogenerated or not (default=TRUE)                                              |
...
| -------- | ----------------------------------------------------------- | ------------------------------------ |
| param    | <code>object</code>                                         | object containing all the parameters |
| param.id | <code>string</code> \| <code>real</code> \| <code>id</code> | id of the sketch object              |
...
| [param.isConstruction]  | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the line is a construction geometry                                                                           |
| [param.genFixation]     | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if fixation in the Origin should be autogenerated or not (default=TRUE)                                          |
| [param.genIncidence]    | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if coincidence constraints between an existing and the new point should be autogenerated or not (default=TRUE)   |
...
Merges the split curves back after trimming, finalizing the trim operation.
This is the third step of the trim workflow: preTrim ? trim ? postTrim.
...
Splits curves at their mutual intersection points, preparing them for trimming.
This is the first step of the trim workflow: preTrim ? trim ? postTrim.

If curveIds is provided, only those curves are split against each other.
If curveIds is omitted, all curves in the sketch are split.
...
| param            | <code>object</code>                                         | object containing all the parameters                                                                |
| param.id         | <code>string</code> \| <code>real</code> \| <code>id</code> | id of the sketch                                                                                    |
| [param.curveIds] | <code>Array&lt;(string\|real\|id)&gt;</code>                | optional array of curve ids to split (lines, arcs, circles, ...). If omitted, all curves are split. |
...
| [param.isConstruction] | <code>boolean</code>                                        | <code>FALSE</code> | a flag which defines if the rectangle lines are construction geometry                                                                                |
| [param.genFixation]    | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if fixation in the Origin should be autogenerated or not (default=TRUE)                                                         |
| [param.genIncidence]   | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if coincidence constraints between an existing point and the new rectangle corner should be autogenerated or not (default=TRUE) |
| [param.genTangency]    | <code>boolean</code>                                        | <code>TRUE</code>  | a flag which defines if tangency constraints between an existing arc and new rectangle should be autogenerated or not (default=TRUE)                 |
...
**_Use preTrim instead. splitAllCurves does not support subset splitting via curveIds
and returns a flat array instead of structured per-curve results._**

Splits all curves in the given sketch at their mutual intersection points.
Used together with trimCurves and splitCurvesMergeBack.
...
Note: This requires exact normalized parameter values [0,1] for where to cut.
These values correspond to the internal curve parameterization and are typically
computed by the sketcher plugin (e.g., from intersection calculations).
For most use cases where you want to split at intersections, prefer the
preTrim/trim/postTrim workflow which computes split positions automatically.
...
| param.splits.values | <code>Array&lt;real&gt;</code>                              | split values in range [0,1]. Position on the curve from start to end |
...
**_Use splitCurve instead (singular). This function returns a flat array.
splitCurve returns a structured result with sourceId and intervals per curve._**
...
**_Use postTrim from trimming workflow instead._**
...
Removes curve segments produced by preTrim.
This is the second step of the trim workflow: preTrim ? trim ? postTrim.
...
| param          | <code>object</code>                                         | object containing all the parameters                     |
| param.id       | <code>string</code> \| <code>real</code> \| <code>id</code> | id of the sketch                                         |
| param.curveIds | <code>Array&lt;(string\|real\|id)&gt;</code>                | ids of curve segments to trim away (from preTrim result) |
...
**_Use trim from trimming workflow instead._**
