...
Returns the product id from a given instance.
...
```
{
  result: id|VOID  // id of the product referenced by the instance
  messages?: { message: string, level: real, code: real, api: string }[]
  maxLevel?: real
}
```
...
| ---------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| param            | <code>object</code>                                         | object containing all the parameters                        |
| param.instanceId | <code>string</code> \| <code>real</code> \| <code>id</code> | id or identifier of the instance to get the product id from |

**Example**

```js
api.v1.assembly.getProduct({ instanceId: instance })
```
